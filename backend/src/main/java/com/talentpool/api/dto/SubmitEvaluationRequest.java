...
public record SubmitEvaluationRequest(
    @JsonAlias("invitationToken") @NotBlank(message = "Invitation token is required") String token,
    ...
    @NotBlank(message = "Programming language is required")
        ...
        String lenguaje,
    @Min(value = 0, message = "Minutes employed cannot be negative") Integer minutosEmpleados) {}
